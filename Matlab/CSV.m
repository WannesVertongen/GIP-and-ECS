...
%theta_opt = pi/4;
dx_robot = 1.0*2;  %horizontale verplaatsing robot [m]
...
velocity_abrupt(1:ceil(T/(timestep*2))) = velocity(1:ceil(T/(timestep*2)));
 ...
 writematrix(position_abrupt,'poly_position_abrupt_053_100.csv')
 writematrix(velocity_abrupt,'poly_velocity_abrupt_053_100.csv')
