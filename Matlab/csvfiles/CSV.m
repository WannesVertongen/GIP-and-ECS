...
velocity_abrupt(1:ceil(T/(timestep*2))) = velocity(1:ceil(T/(timestep*2)));
 ...
 writematrix(position_abrupt,'poly_position_abrupt_060_0753.csv')
 writematrix(velocity_abrupt,'poly_velocity_abrupt_060_0753.csv')
